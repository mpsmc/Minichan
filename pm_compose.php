...
if(isset($_GET['replyto'])) {
	...
	if($destination == 'mods' && !allowed("mod_pm")) $error = true;
	if($destination == 'admins' && !$administrator) $error = true;
	if(($destination != 'mods' && $destination != 'admins') && ($destination != $_SESSION['UID'])) $error = true;
...
if(isset($_POST['contents']) && isset($_POST['submit'])) {
	...
	if($_SESSION['num_pms'] > 0) $_SESSION['num_pms'] = $_SESSION['num_pms'] - 1;
