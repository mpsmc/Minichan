...
if(!ENABLE_GOLD_ACCOUNTS) die("Gold accounts are not enabled");
...
switch ($_GET['action']) {
   ...
   case 'process':      // Process and order...
	  ...
	  if(!$_SESSION['UID']) die("You need to have a valid account to buy a gold account.");
