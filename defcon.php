...
<input type="radio" name="id" value="1" id="defcon_1"<?php echo $def1; if (!$administrator) {
     echo ' disabled';
 } ?>> <label for="defcon_1">DEFCON 1 — Block everyone from accessing the board except for Administrators.</label><br>
<input type="radio" name="id" value="2" id="defcon_2"<?php echo $def2; if (!$administrator) {
     echo ' disabled';
 } ?>> <label for="defcon_2">DEFCON 2 — Block all users except for Moderators and Administrators from posting.</label><br>
