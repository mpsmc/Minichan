...
Graph.prototype = {
    ...
    addEdge: function(source, target, style, content1, content2) {
        var s = this.addNode(source, content1);
        var t = this.addNode(target, content2);
...
Graph.Renderer.Raphael = function(element, graph, width, height) {
	...
	this.mouseup = function (e) {
		if(e.which != 2) return;
		middleClickHandler && middleClickHandler(this);
	};
    ...
    drawNode: function(node) {
        ...
        if(!node.render) {
            node.render = function(r, node) {
                ...
                return shape;*/
				/* the default node drawing */
				var color = ((node.is == 'uid') ? "#ff0000" : "#00ff00");
				/* set DOM node ID */
				//ellipse.node.id = node.label || node.id;
				shape = r.set().
