...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" id="top">
	<head>
		...
		<script type="text/javascript" src="<?php echo STATIC_DOMAIN; ?>javascript/main.js?x3"></script>
		<script type="text/javascript" src="<?php echo STATIC_DOMAIN; ?>javascript/topic.js?x0"></script>
		<script type="text/javascript" src="<?php echo STATIC_DOMAIN; ?>javascript/extras.js?x6"></script>
