...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" id="top">
	<head>
		...
		<script type="text/javascript" src="<?php echo STATIC_DOMAIN; ?>javascript/resizable_columns.js?0"></script>
		...
		<script type="text/javascript" src="<?php echo STATIC_DOMAIN; ?>javascript/extras.js?x7"></script>
...
<!-- <script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#pubid=ra-4db55d8a51bfcd4c"></script> -->
	...
	<?php
		...
		if(!MOBILE_MODE && $rounded_corners) {
			echo 'resizable_columns ';
		}
		echo '"';
		echo '>';
