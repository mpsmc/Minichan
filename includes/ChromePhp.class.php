...
class Console
{
     ...
     * @var string
     */
    const COOKIE_SIZE_WARNING = 'cookie size of 4kb exceeded! try Console::useFile() to pull the log data from disk';
     ...
     * @param string label
     * @param mixed value
     * @param string severity Console::LOG || Console::WARN || Console::ERROR
     * @return void
     */
    ...
    protected function _cookieMonster()
    {
        ...
        $this->_json['rows'][] = array(null, self::COOKIE_SIZE_WARNING, 'Console', self::WARN);
