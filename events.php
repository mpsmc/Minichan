...
if (!$num = mysql_num_rows($send)) {
    echo '<h2>No events on this page</h2>';
...
echo '<table>
    ...
    if ($page == 1 && $num > $number) {
        echo '<ul class="menu"> <li> <a href="'.DOMAIN.'events/'.$page + 1 .'">Older</a></li></ul>';
    }
    if ($page > 1 && $num > $number) {
        echo '<ul class="menu"> <li> <a href="'.DOMAIN.'events/1">Newest</a></li> <li> <a href='.DOMAIN.'events/'.$page - 1 .'">Newer</a></li> <li> <a href="'.DOMAIN.'events/'.$page + 1 .'">Older</a></li></ul>';
    }
