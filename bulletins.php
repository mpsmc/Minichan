...
$number = 50;
if($page == 1) {
	$start = 0; $finish = $start + $number; // Getting the limit results.
	} else { 
	$start = $page - 1; $start = $start * $number; $finish = $number;
	}
...
if(!$link->num_rows($send)) {
	echo '<h2>No bulletins found.</h2>'; require 'includes/footer.php'; die();
	}
