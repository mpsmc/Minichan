...
$link->db_exec("SELECT count(mod_UID) as amount, mod_UID FROM mod_actions WHERE action = 'delete_reply' or action = 'delete_topic' GROUP BY mod_UID ORDER BY amount DESC");
