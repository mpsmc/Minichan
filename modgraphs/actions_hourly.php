...
$caption = "Moderator actions/hour over the past 24 hours";
$sql = "SELECT (UNIX_TIMESTAMP() - time) as order_by, DATE_FORMAT(FROM_UNIXTIME(time), \"%H\") as period, count(time) as actions FROM mod_actions WHERE time > (UNIX_TIMESTAMP() - 3600*23) GROUP BY period ORDER BY `order_by` DESC";
